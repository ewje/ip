...
If asked to write a commit message for the reviewed changes, keep it imperative and include a short body explaining what changed and why.
...
4. Run the bundled generator from the repository root:
   ...
   ```bash
   python3 "${CODEX_HOME:-$HOME/.codex}/skills/present-changes-visually/scripts/generate-split-view-diff.py" \
